...
@ScriptManifest(authors = { "OneThatWalks/Foulwerp" }, category = "Combat", name = "Epic Foul Fighter Pro", version = 0.70, description = "Settings In GUI <html> <head> </head> <body><br>Thanks to,<br> -Marselo for some Locations <br> -Javac and Pervy Shuya for help <br> -Foulwerp for original script <br> and To anyone else that helped </body> </html>")
public class EpicFoulFighterPro extends Script implements PaintListener,
	...
	public EpicFoulFighterPro.gui2 gui2;

...
@ScriptManifest(authors = { "Taha", "Jacmob", "SpeedWing" }, category = "Smithing", name = "Epic Smart Smelter", version = 2.3, description = "<html><body style='font-family: Arial; margin: 10px;'><span style='color: #00AA00; font-weight: bold;'>Smart Smelter</span>&nbsp;<strong>Version:&nbsp;2.3</strong><br />Select your account and press OK to configure the script settings.</body></html>")
public class EpicSmartSmelter extends Script implements PaintListener,
	...
	private final int oreSelectionInterface = 905;
	...
	private class SmartSmelterGUI extends JFrame {
		...
		// GEN-END:variables
		private SmartSmelterGUI(final EpicSmartSmelter scr) {
			script = scr;
			initComponents();

...
@ScriptManifest(authors = { "Fallen" }, category = "Magic", name = "Fallen's Superheater at Cw", version = 4.0, description = "<html><head>"
		...
		+ "</body></html>")
public class FallenSuperheaterAtCw extends Script implements PaintListener,
	...
	public static final  int[] BankChests = { 4483, };
	...
	public int loop() {
		...
		final RSObject bankChest = getNearestObjectByID(BankChests);

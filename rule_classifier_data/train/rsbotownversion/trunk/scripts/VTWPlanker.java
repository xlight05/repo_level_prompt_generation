...
@ScriptManifest(authors = {"Versus The World"}, category = "Money-Making", name = "VTW Planker", version = 1.6, description = "<html><body style='font-family: Arial; padding: 0px; background-color: #FFFFFF;'><center><b>Setup in GUI</b><br /><br />Start the script inside Varrock East bank with the amount of coins you wish to use in ur inventory. The script will run until you run out of either coins in inventory or logs in the bank. <br /><br />This is an AIO Planker. It offers every type of plank, and if you choose, will rest at the musician when needed.</center></body></html>")

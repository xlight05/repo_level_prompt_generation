...
@ScriptManifest(authors = { "Nobody, maintained by elf2345" }, category = "Combat", name = "Zombie Cage Ranger", version = 3.3, description = 
      "<html><body bgcolor = #556B2F><font color = #FFD700><center><h2>Nobody's Zombie Cage Ranger: </h2>"
    + "<h3>Maintained by elf2345.</h3><hr />"
    + "<font size =\"4\">Start in Traning Ground with Sling in Wizard Guild underground.<br /><hr /><table border='0'>"
...
public class ZombieCageRanger extends Script implements ServerMessageListener, PaintListener {
    ...
    public boolean onStart(Map<String, String> args) {
        ...
        log("*******************************************************************************");
        log(" ");
        log("You are Using Zombie Cage Ranger, Created by Nobody & Maintained by elf2345!");
    ...
    public int loop() {
        ...
        if (getInterface(210, 1).containsText("The Abyssal Services Department apologises for the inconvenience.") && (getInterface(210, 1).getAbsoluteY() > 380) && (getInterface(210, 1).getAbsoluteY() < 410)) {
        ...
        if (CheckSeed() && getMyPlayer().getInteracting() == null
                && getNearestFreeNPCByID(Zombie) != null) {
            status = "Fighting...";
            clickNPC(getNearestFreeNPCByID(Zombie), "Attack");
        }
        return 800;
    }
    ...
    public void onRepaint(Graphics g) {
      ...
      if (paintSelection == 1) {
        g.setColor(white);
        g.drawString("Zombie Cage Ranger", 380, y += 14);
        g.setColor(blue);

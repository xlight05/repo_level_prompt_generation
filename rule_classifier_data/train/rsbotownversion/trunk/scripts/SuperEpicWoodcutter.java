...
public class SuperEpicWoodcutter extends Script implements PaintListener {
	...
	public boolean onStart(final Map<String, String> args) {
		...
		if (args.get("willows").equals("Willows 2")) {
			willowTreesLocation = new RSTile(2914,3301);
		}
		if (args.get("willows").equals("Willows 3")) {
			willowTreesLocation = new RSTile(3060,3253);
		}
		return true;
	}

...
@ScriptManifest(authors = { "Famous" }, category = "Mining", name = "Famous Power Miner", version = 3.4, description = "<html><head>"
		+ "</head><body>"
		+ "<center>"
		...
		+ "</font></b>"
		+ "<br></br>"
		+ "<i><font size=\"4\" color=\"black\">Only works in East Ardougne ( Iron ) and do not bank. This script checks for the latest updates.</font></i>"
		+ "<br></br>"
		...
		+ "<option>No"
		+ "<br></br>" + "</body></html>")
public class FamousPowerMiner extends Script implements PaintListener,
		ServerMessageListener {

	// Variables
	int[] gemID = { 1617, 1619, 1621, 1623 };
	int[] pickaxe = { 1265, 1267, 1269, 1271, 1273, 1275, 1296, 13661, 14107,
			380302, 379433, 379181, 995, 14664, 2528, 15532, 15533, };
	...
	public int loop() {
		...
		} else if (Location.equals("East Ardougne")) {
			if (isInventoryFull()) {
				if (powerMine) {
					status = "Dropping Ore";
					drop();
	...
	public boolean onStart(final Map<String, String> args) {
		...
		} else if (FIM2.equals("East Ardougne")) {
		...
		if (FIM5.equals("Tin")) {
			...
			ore = 440;
			rockSelected = "Iron";
			rock = new int[] { 2092, 2093, 11954, 11955, 11956, 9719, 9717, 9718, 29221,
		...
		if (FIM2.equals("East Varrock") && (FIM5.equals("Tin"))) {
			...
			// /////East Ardougne//////////
			// /////////////////////////
		} else if (FIM2.equals("East Ardougne") && (FIM5.equals("Gold"))) {
			mineTile = new RSTile(2976, 3235);
		} else if (FIM2.equals("East Ardougne") && (FIM5.equals("Tin"))) {
			mineTile = new RSTile(2986, 3237);
		} else if (FIM2.equals("East Ardougne") && (FIM5.equals("Iron"))) {
			mineTile = new RSTile(2713, 3331);
		} else if (FIM2.equals("East Ardougne") && (FIM5.equals("Copper"))) {
			mineTile = new RSTile(2979, 3246);
		} else if (FIM2.equals("East Ardougne") && (FIM5.equals("Clay"))) {
			mineTile = new RSTile(2986, 3237);
			// /////////////////////////
			// /////West Varrock////////
			// /////////////////////////

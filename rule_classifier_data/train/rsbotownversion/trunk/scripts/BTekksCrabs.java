...
@ScriptManifest(authors = {"Tekk & B-Warrior"}, category = "Combat", name = "BTekksCrabs", version = 2.9, description = "<i><b>BTekksCrabs v2.9</b> By Tekk & B-Warrior</i><br /><b>Start at the eastern crabs. </b>")
public class BTekksCrabs extends Script implements PaintListener {
    ...
    private int eatAtHP = random(180, 230);
    ...
    private void eatFood() {
        int currentHP = Integer.parseInt(RSInterface.getInterface(748).getChild(8).getText());
 ...
 */
   ...
   public void startActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public void onRepaint(Graphics render) {
        ...
        render.drawString("BTekksCrabs v2.9", 15, 25);

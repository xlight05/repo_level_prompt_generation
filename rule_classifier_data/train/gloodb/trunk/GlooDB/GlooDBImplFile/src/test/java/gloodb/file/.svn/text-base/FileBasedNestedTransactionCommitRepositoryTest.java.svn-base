...
public class FileBasedNestedTransactionCommitRepositoryTest extends NestedTransactionCommitRepositoryTestBase {
    ...
    /**
     * Creates a repository test set using file based transaction and storage
     * strategies. 
     */
    public FileBasedNestedTransactionCommitRepositoryTest(Repository repository, PersistentFactorySimpleVersioned factory,

...
public class BlockStorageTest extends StorageTestBase {
    ...
    public void setUp() {
        ...
        BlockStorageConfiguration configuration = new BlockStorageConfiguration(nameSpace, new NullCipher(), new NullCipher());
        configuration.setVerificationOn(true);
        this.storage = storageFactory.buildStorage(configuration, null);
    }

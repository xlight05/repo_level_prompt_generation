...
/**
 * <p>
 * Tagging annotation for PreUpdate callback methods. A single method per class
 ...
 * </p>
 * This method is invoked before the object is updated in the repository.
 * Throwing an exception from this method prevents the object store.

...
public interface Repository {
	...
	/**
	 * Queries the repository and returns the query result. Depending on the query type,
	 * the query is guarded by a write lock (UpdateQuery), read lock (ReadOnlyQuery) or
	 * unguarded. 
	 * 
	 * @param query
	 *            The query.
	 ...
	 */
	<T extends Serializable> QueryResult<T> query(Query<T> query, Serializable... parameters);

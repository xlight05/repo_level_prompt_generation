...
public class InvalidPersistentIdentityTest {
   ...
   public static Collection<Object []> data() {
        Object[][] data = new Object [][] {
                ...
                {new DuplicatedFieldIdentityTest1(), "Duplicated idx value 1 found for identity field " +
                ...
                {new DuplicatedMixedClassAndFieldIdentityTest1(), "Duplicated idx value 0 found for identity field " +
                ...
                {new DuplicatedMixedClassAndFieldIdentityTest2(), "Duplicated idx value 1 found for identity field " +

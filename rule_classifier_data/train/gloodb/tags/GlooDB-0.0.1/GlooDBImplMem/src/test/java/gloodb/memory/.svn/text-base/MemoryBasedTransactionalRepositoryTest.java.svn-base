...
public class MemoryBasedTransactionalRepositoryTest extends TransactionalRepositoryTestBase {
     ...
     */
    public MemoryBasedTransactionalRepositoryTest(Repository repository, PersistentFactorySimpleVersioned factory ) {

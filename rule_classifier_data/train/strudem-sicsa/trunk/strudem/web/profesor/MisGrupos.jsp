            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-title">
                        ...
                        <span class="subtitle">Asistencias y otra información relacionada</span>
                    </div>
                    <!-- ENDS title -->
                            ...
                            <table  id="example">
                                ...
                                <tbody>
                                    <s:iterator value="lista">
                                        <tr>
                                            <td><s:property value="lista_asistencia_id"/></td>
                                            <td><s:property value="grado"/></td>
                                            <td><s:property value="grupo"/></td>
                                            <td><s:property value="horas_por_semana"/> horas</td>
                                            <td><s:property value="periodo"/></td>
                                            <td>
                                                <s:url action="listaAsistenciaVacio" id="asistList">
                                                    <s:param name="lista_asistencia_id">
                                                        <s:property value="lista_asistencia_id"/>
                                                    </s:param>
                                                </s:url>
                                                <s:url action="listaAsistenciaGenerar" id="genAsistList">
                                                    <s:param name="lista_asistencia_id">
                                                        <s:property value="lista_asistencia_id"/>
                                                    </s:param>
                                                </s:url>

                                                <s:a href="%{asistList}"><img src="<s:url value="/img/mono-icons/linedpaperplus32.png"/>" alt="Lista Asistencia Vacio" title="Lista de Asistencia Vacia" /></s:a>
                                                <s:a href="%{genAsistList}"><img src="<s:url value="/img/mono-icons/linedpapercheck32.png"/>" alt="Reporte de Asistencia" title="Generar reporte de asistencias" /></s:a>
                                                </td>
                                            </tr>
                                    </s:iterator>

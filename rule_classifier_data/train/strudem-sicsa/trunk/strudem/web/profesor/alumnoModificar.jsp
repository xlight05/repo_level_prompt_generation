                    ...
                    <div id="page-content">
                        ...
                        <s:iterator value="lista">
                            <s:form action="alumnoModificar">
                                <s:textfield label="ID" name="alumno_id" ><s:property value="alumno_id"/></s:textfield>
                                ...
                                <s:textfield label="Carrera" name="carrera_id"><s:property value="carrera_id"/></s:textfield>

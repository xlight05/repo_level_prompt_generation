...
<html>
    ...
    <body class="home">
        ...
        <!-- Menu -->
        <s:div id="menu">
            <s:url var="menuJsp" value="/profesor/menu.action"/>
            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-content">
                        ...
                        <h4 class="line-divider">Agregar una nuevo Alumno </h4>

                        <s:form action="alumnoInsertar">
                            <s:actionerror cssClass="error-box"/>
                            <s:fielderror  cssClass="error-box"/>
                            <s:textfield label="Nombre Alumno" name="nombre"></s:textfield>
                            ...
                            <s:textfield label="Matricula" name="matricula"></s:textfield>
                            <s:textfield label="Carrera" name="carrera_id"></s:textfield>

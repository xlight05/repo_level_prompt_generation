        ...
        <div id="menu-holder">
            ...
            <div class="wrapper">
                ...
                <ul id="nav" class="sf-menu">
                    <li class="current-menu-item"><s:a href="/strudem/profesor/profesor.action">Inicio<span class="subheader">Profesor</span></s:a></li>

                    <li><s:a href="profesor.action">Profesor<span class="subheader">Panel Docente</span></s:a>
                        <ul>
                            <li><s:a href="#"><span> Mi Horario</span></s:a></li>
                            <li><s:a href="GrupoProfesorLista.action"><span> Mis Grupos</span></s:a></li>
                        </ul>
                    </li>
                    <li><s:a href="/strudem/profesor/alumnos.action">Alumnos<span class="subheader">Académico</span></s:a>
                        <ul>
                    ...
                    <li><s:a href="profesor.action">Perfíl<span class="subheader">Mi Cuenta</span></s:a>
                        <ul>

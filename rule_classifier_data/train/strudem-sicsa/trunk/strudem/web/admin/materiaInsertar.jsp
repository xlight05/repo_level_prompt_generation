            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-content">
                        ...
                        <h4 class="line-divider">Agregar una nueva Materia </h4>
                         <s:a cssClass="link-button" href="javascript: history.go(-1)"><span>Regresar</span></s:a>

                        <s:form action="materiaInsertar">
                            <s:actionerror cssClass="error-box"/>
                            <s:fielderror  cssClass="error-box"/>
                            <s:textfield label="Nombre del Materia" name="nombre"></s:textfield>
                            <s:textfield label="Id del Cuatrimestre" name="cuatrimestre_id"></s:textfield>

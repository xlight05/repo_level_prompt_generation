            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-title">
                        ...
                        <span class="subtitle">Información relacionada a los grados y grupos de todas las carreras</span>
                    </div>
                    <!-- ENDS title -->
                    ...
                    <div id="page-content">
                        ...
                        <h4 class="line-divider">Lista de grupos</h4>
                        ...
                        <table>
                            ...
                            <tbody>
                                <s:iterator value="lista">
                                    <tr>
                                        <td><s:property value="grupo_id"/></td>

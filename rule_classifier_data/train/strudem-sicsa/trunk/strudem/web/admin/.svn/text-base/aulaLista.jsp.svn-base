            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-content">
                        ...
                        <h4 class="line-divider">Lista de aulas de todos los edificios</h4>
                        ...
                        <table>
                            ...
                            <tbody>
                                <s:iterator value="lista">
                                    <tr>
                                        <td><s:property value="aula_id"/></td>
                                        <td><s:property value="descripcion"/></td>

                                        <td>
                                            <s:url action="aulaEditar" id="ediReg">
                                                <s:param name="aula_id">
                                                    <s:property value="aula_id"/>
                                                </s:param>
                                            </s:url>
                        ...
                        <p>
                            <s:a href="aulaNuevo.action"><img src="<s:url value="/img/mono-icons/plus32.png"/>" alt="Agregar registro" title="Agregar Registro"/></s:a>

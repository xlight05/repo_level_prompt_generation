            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-content">
                        ...
                        <h4 class="line-divider">Modificar un registro de aula</h4>
                        <s:fielderror cssClass="error-box" />
                        
                        <s:iterator value="lista">
                            <s:form action="aulaModificar">
                                <s:textfield label="ID" name="aula_id" ><s:property value="aula_id"/></s:textfield>
                                <s:textfield label="Aula" name="descripcion"><s:property value="descripcion"/></s:textfield>

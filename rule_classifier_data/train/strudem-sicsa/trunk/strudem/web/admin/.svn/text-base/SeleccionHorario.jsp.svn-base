            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-content">
                        ...
                        <h4 class="line-divider">Selecciona el horario</h4>
                        <table>
                            <thead>
                                <tr>
                                    <th><b>ID</b></th>
                                    <th><b>Nombre del Profesor</b></th>
                                ...
                                <s:iterator value="lista">
                                    <tr>
                                        ...
                                        <td><s:property value="a_materno"/></td>
                                            ...
                                            <td>
                                            <s:url action="horariosTodos" id="ediReg">
                                                <s:param name="profesor_id">
                                                    <s:property value="profesor_id"/>
                                                </s:param>
                                            </s:url>

                                            <s:a href="%{ediReg}"><img src="Consultar Horario" alt="Consultar Horario" title="Consultar Horario" /></s:a>

...
<html>
    <head>
        ...
        <title>Configuración :: SICSA</title>
            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-title">
                        ...
                        <span class="subtitle">de todos los profesores</span>
                    </div>
                    <!-- ENDS title -->
                    ...
                    <div id="page-content">
                            ...
                            <table id="example">
                                ...
                                <tbody>
                                    <s:iterator value="lista">
                                        <tr>
                                            <td><s:property value="clase_id"/></td>
                                            ...
                                            <td>
                                                <s:url action="claseEditar" id="ediReg">
                                                    <s:param name="clase_id">
                                                        <s:property value="clase_id"/>
                                                    </s:param>
                                                </s:url>
                        ...
                        <p>
                            <s:a href="claseNuevo.action"><img src="<s:url value="/img/mono-icons/plus32.png"/>" alt="Agregar registro" title="Agregar Registro"/></s:a>

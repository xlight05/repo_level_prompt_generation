            ...
            <div class="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="page-content">
                        ...
                        <h4 class="line-divider">Lista de usuarios</h4>
                            ...
                            <tbody>
                                <s:iterator value="lista">
                                    <tr>
                                        ...
                                        <td>
                                            <s:url action="usuarioEditar" id="ediReg">
                                                <s:param name="usuario_id">
                                                    <s:property value="usuario_id"/>
                                                </s:param>
                                            </s:url>
                        ...
                        <p>
                            <s:a href="usuarioNuevo.action"><img src="<s:url value="/img/mono-icons/plus32.png"/>" alt="Agregar registro" title="Agregar Registro"/></s:a>

                ...
                <div id="content">
                    ...
                    <div id="page-content">
                        ...
                        <s:iterator value="lista">
                            <s:form action="usuarioModificar">
                                <s:textfield label="ID" name="usuario_id" ><s:property value="usuario_id"/></s:textfield>
                                <s:textfield label="Usuario" name="usuario"><s:property value="usuario"/></s:textfield>
                                <s:textfield label="Contraseña" name="password"><s:property value="password"/></s:textfield>

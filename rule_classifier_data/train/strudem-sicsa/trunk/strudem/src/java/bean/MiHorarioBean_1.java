 ...
 */
public class MiHorarioBean_1 extends ActionSupport {
    ...
    public String MiHorarioLista(){
        
        MiHorarioDao dao = new MiHorarioDao();
        
        
        setLista(dao.miHorarioLista());
        setLista2(dao.profesoresLista());

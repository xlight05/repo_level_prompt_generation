 ...
 *
 */
public class DaoException extends FastException {
	private static final long serialVersionUID = 1054794536391305950L;
	...
	public DaoException(String code, String message, String[] arguments) {
		super(message);
		this.code = code;

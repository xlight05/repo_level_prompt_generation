 ...
 *
 */
public class CreateReadUpdatePagingAwareDaoImpl<M extends PagingAwareModel, K extends Serializable> extends DaoImpl<M>
		implements CreateAwareDao<M>, ReadAwareDao<M, K>, UpdateAwareDao<M>, PagingAwareDao<M> {
	protected CreateHelper createHelper;
	protected ReadHelper readHelper;
	protected UpdateHelper updateHelper;
	protected PagingHelper pagingHelper;

	public CreateReadUpdatePagingAwareDaoImpl(final Class<M> persistentClass) {

 ...
 *
 */
public class CreateReadPagingAwareDaoImpl<M extends PagingAwareModel, K extends Serializable> extends DaoImpl<M>
		implements CreateAwareDao<M>, ReadAwareDao<M, K>, PagingAwareDao<M> {
	protected CreateHelper createHelper;
	protected ReadHelper readHelper;
	protected PagingHelper pagingHelper;

	public CreateReadPagingAwareDaoImpl(final Class<M> persistentClass) {

 ...
 *
 */
public class CreateReadUpdateDeleteCountAwareDaoImpl<M extends Model, K extends Serializable> extends DaoImpl<M>
		implements CreateAwareDao<M>, ReadAwareDao<M, K>, UpdateAwareDao<M>, DeleteAwareDao<M>, CountAwareDao<M> {
	...
	public CreateReadUpdateDeleteCountAwareDaoImpl(final Class<M> persistentClass) {

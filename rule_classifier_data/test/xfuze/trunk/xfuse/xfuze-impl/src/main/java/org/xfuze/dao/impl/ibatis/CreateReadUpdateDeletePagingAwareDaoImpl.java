 ...
 *
 */
public class CreateReadUpdateDeletePagingAwareDaoImpl<M extends PagingAwareModel, K extends Serializable> extends
		DaoImpl<M> implements CreateAwareDao<M>, ReadAwareDao<M, K>, UpdateAwareDao<M>, DeleteAwareDao<M>,
		PagingAwareDao<M> {
	...
	public CreateReadUpdateDeletePagingAwareDaoImpl(final Class<M> persistentClass) {

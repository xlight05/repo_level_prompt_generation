 ...
 *
 */
public class CreateReadUpdateAwareDaoImpl<M extends Model, K extends Serializable> extends DaoImpl<M> implements
		CreateAwareDao<M>, ReadAwareDao<M, K>, UpdateAwareDao<M> {
	protected CreateHelper createHelper;
	protected ReadHelper readHelper;
	protected UpdateHelper updateHelper;

	public CreateReadUpdateAwareDaoImpl(final Class<M> persistentClass) {

 ...
 */
JNIEXPORT jint JNICALL
Java_org_xfuze_tool_pref_SystemInformation_getCPUs (JNIEnv * env, jclass cls)
{
...
Java_org_xfuze_tool_pref_SystemInformation_getSysInfo (JNIEnv * env, jclass cls)
{
    char buf[2048]; 
    char buf2[512];
    *buf=0;
 ...
 */
JNIEXPORT jint JNICALL
Java_org_xfuze_tool_pref_SystemInformation_getProcessID (JNIEnv * env, jclass cls)
{
    return s_PID;
}
/* ......................................................................... */
 ...
 */
JNIEXPORT jint JNICALL
Java_org_xfuze_tool_pref_SystemInformation_setPid (JNIEnv * env, jclass cls, jint pid)
{
    DWORD errCode;
    LPVOID lpMsgBuf;
    s_PID = pid;
 ...
 */
JNIEXPORT jint JNICALL
Java_org_xfuze_tool_pref_SystemInformation_detachProcess (JNIEnv * env, jclass cls)
{
    if (!alreadyDetached && s_currentProcess!=NULL) {
	    CloseHandle(s_currentProcess);
	    alreadyDetached = 1;
...
Java_org_xfuze_tool_pref_SystemInformation_getProcessCPUTime (JNIEnv * env, jclass cls)
{
 ...
 */
JNIEXPORT jlong JNICALL
Java_org_xfuze_tool_pref_SystemInformation_getMaxMem (JNIEnv * env, jclass cls)
{
	MEMORYSTATUS stat;
 ...
 */
JNIEXPORT jlong JNICALL
Java_org_xfuze_tool_pref_SystemInformation_getFreeMem (JNIEnv * env, jclass cls)
{
        MEMORYSTATUS stat;
	GlobalMemoryStatus (&stat);
...
Java_org_xfuze_tool_pref_SystemInformation_getProcessCPUUsage (JNIEnv * env, jclass cls)
{
 ...
 */
JNIEXPORT jdouble JNICALL
Java_org_xfuze_tool_pref_SystemInformation_getProcessCPUPercentage (JNIEnv * env, jclass cls)
{
 ...
 */
JNIEXPORT jlong JNICALL
Java_org_xfuze_tool_pref_SystemInformation_getMemoryUsage (JNIEnv * env, jclass cls)
{
 ...
 */
JNIEXPORT jlong JNICALL
Java_org_xfuze_tool_pref_SystemInformation_getMemoryResident (JNIEnv * env, jclass cls)
{
    PROCESS_MEMORY_COUNTERS pmc;

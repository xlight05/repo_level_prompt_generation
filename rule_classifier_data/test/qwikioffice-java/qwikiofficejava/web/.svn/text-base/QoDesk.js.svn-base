...
QoDesk.QoAdmin = Ext.extend(Ext.app.Module, {
	...
	launcher : {
        ...
        shortcutIconCls: 'pref-shortcut-icon',
        text: 'Administration',
        tooltip: '<b>Admin</b><br />Allows you to admin your desktop'
    }
});
...
return {"saveShortcut":["qo-preferences"],"saveQuickstart":["qo-preferences"],"saveAppearance":["qo-preferences"],"saveBackground":["qo-preferences"],"viewWallpapers":["qo-preferences"],"viewThemes":["qo-preferences"],"saveAutorun":["qo-preferences"]};
...
return [ new QoDesk.QoPreferences(),new QoDesk.GridWindow(),new QoDesk.TabWindow(),new QoDesk.AccordionWindow(),new QoDesk.LayoutWindow(),new QoDesk.BogusWindow(),new QoDesk.QoAdmin()];
...
return {"shortcut":["demo-tabs","qo-preferences"],"autorun":["admin-module"],"quickstart":["qo-preferences","qo-preferences","demo-grid","demo-acc","demo-layout","demo-bogus","demo-tabs"],"contextmenu":["qo-preferences","admin-module"]};

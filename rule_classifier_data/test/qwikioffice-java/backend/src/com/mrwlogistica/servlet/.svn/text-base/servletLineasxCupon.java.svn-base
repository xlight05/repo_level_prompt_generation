/*
 * servletLineasxCupon.java
 *
 * Created on 16 de febrero de 2008, 17:06
 */

package com.mrwlogistica.servlet;

import com.mrwlogistica.model.BEANLinxCup;
import java.io.*;
import java.net.*;
 ...
 * @version
 */
public class servletLineasxCupon extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      String cb = request.getParameter("callback");
       BEANLinxCup _dato = new BEANLinxCup();
       ...
       String _where =" WHERE CUP_CODNUM=?";

...
<body>
	...
	<s:form action="registerstaff" validate="true">
		<s:token />
		<s:textfield name="username" label="Username" required="true"/>
		<s:textfield name="staffNo" label="Staff Number" required="true"/>
		<s:select list="staffTypes" name="staffType" label="Staff Type" />

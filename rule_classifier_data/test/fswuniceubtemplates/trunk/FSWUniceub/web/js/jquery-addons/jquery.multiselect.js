...
$.widget("ech.multiselect", {
	...
	options: {
		...
		minWidth: 225,
		classes: '',
		checkAllText: 'Marcar todos',//Check all',
		uncheckAllText: 'Desmarcar todos',//Uncheck all',
		noneSelectedText: 'Selecione',//Select options',
		selectedText: '# selecionados',//# selected',
		selectedList: 0,
		show: '',
		hide: '',
		autoOpen: false,

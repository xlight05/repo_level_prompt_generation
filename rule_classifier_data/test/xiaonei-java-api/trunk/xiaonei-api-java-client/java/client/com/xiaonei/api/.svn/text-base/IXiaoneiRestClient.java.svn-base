...
/**
   ...
   * @param amount
   * @param desc
   * @param payType支付的类型，0为web支付，1为wap支付
   * @return
   * @throws XiaoneiException
   * @throws IOException
   */
  public T  pay_regOrder(Long orderId,Integer amount,String desc,int payType) throws XiaoneiException,IOException;
  /**
   * 判断用户是否已经完成人人豆支付
   * @param orderId
   * @return
   ...
   * @param amount
   * @param desc
   * @param payType 支付的类型，0为web支付，1为wap支付
   * @return
   * @throws XiaoneiException
   * @throws IOException
   */
  public T  pay4Test_regOrder(Long orderId,Integer amount,String desc,int payType) throws XiaoneiException,IOException;
  /**
   * 用于应用测试
   * 判断用户是否已经完成人人豆支付
   * @param orderId

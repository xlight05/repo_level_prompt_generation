...
public class GridSearch extends SynchronizerService {
	@Override
	public HashMap getServiceValue(HashMap params) throws Exception {
		...
		dataGrid.dispatchSearch(serverDataGridFieldName, serverDataGridSearchToken);

		System.out.println("Executou a busca da grid no servidor!");

...
public class TesteProgress extends Window {
	
	public TesteProgress(HttpSession httpSession) {
		super(httpSession);
	}
			...
			Thread thread = new Thread(){
				...
				public void run() {
					...
					for (int i = 0; i < 100; i++) {						
						...
						TesteProgress.this.showProgress("AAAAAAAAAAAAAAAAAAAAA" + j, duration, j);
					}
				}

...
public class NodeTypeRAOTest extends TestCase {
    ...
    public void testRemoveNodeType() throws NamingException, RepositoryException{
        NodeTypeRAO nodeTypeRAO = NodeTypeRAO.getInstance();
        NodeTypeDef ntdx = nodeTypeRAO.getNodeType(new QName(SOHOCMSURL,"test"));
        nodeTypeRAO.removeNodeType(ntdx.getName());
        NodeTypeDef ntd = nodeTypeRAO.getNodeType(new QName(SOHOCMSURL,"test"));

 ...
 */
package org.jsemantic.core.context.factory;
...
/**
 * A factory for creating SemanticContext objects.
 */
public interface SemanticContextFactory {
	...
	public SemanticContext getContext(RuleSessionFactory rulesSessionFactory,
			KnowledgeDB db, Map<?,?> sessionVariables,
			boolean isStateful) throws SemanticContextCreationException;

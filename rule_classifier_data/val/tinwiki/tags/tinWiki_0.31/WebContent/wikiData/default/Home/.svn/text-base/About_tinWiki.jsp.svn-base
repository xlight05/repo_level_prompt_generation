...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="section0">
			...
			<p>At the same time I was thinking about using a wiki to organize my growing team already reaching 12 developers. The idea of a wiki really made sense, but almost all wiki's reviewed by myself and Mike were overly complex (example, need to learn a new mark-up language), hard to setup and not portable.</p>
			<p>
		...
		<div id="section1">
			...
			<p>** Next Goals</p>
			<ol start="1">
				<li>Update tinmce and refine feature list</li>
				<li>
					Add force refresh for updated html files
					<br clear="none" />
				</li>

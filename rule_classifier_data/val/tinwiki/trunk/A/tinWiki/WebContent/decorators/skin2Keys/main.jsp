...
<html:html xhtml="true">
	<head>
		...
		<%-- Any CSS classes with hard coded references should be copied into .css.jsp files and changed to dynamic. --%>
			...
			<div id="topnavWrapper">
				<div id="topnav">
					<ul><%-- Note spaces between the list items will cause issues with CSS driven display. --%>
						...
						><li id="topNav_Contacts"><a href="<%=request.getContextPath()%>/wikiData/2Keys/Credentials/Credentials.html">Credentials</a></li

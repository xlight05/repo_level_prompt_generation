...
#topnav li a {	
	...
	background: #fff url(<%=request.getContextPath()%>/decorators/skinJin/images/whtgrad.png);
}
...
#topnav li.active a { 
	...
	background: Black url(<%=request.getContextPath()%>/decorators/skinJin/images/blkgrad.png);
...
#crumbs {
	background: #D9DCFF url(<%=request.getContextPath()%>/decorators/skinJin/images/crm_whtbk_1.png);
}
...
.highLighter {
	background: #DFF0FF url(<%=request.getContextPath()%>/decorators/skinJin/images/blubk.png);;
}

.highLighterAdd {
	background: #DDDDDD url(<%=request.getContextPath()%>/decorators/skinJin/images/blkbk.png);
}

...
function addAddLinks(contextPath, fileName) {
	...
	for ( var i = 0; i < sections.length; i++ ) {
		...
		sections[i].innerHTML='<a class="add" ' + mouseOver + ' ' + mouseOut + 'href="' + contextPath + '/web/addSection/addSection.do?sectionName='+sections[i].id+'&fileName='+fileName+'">[insert section <img alt="above" src="'+ contextPath +'/decorators/modifyContentControls/images/arrow_add_above.png" />]</a>'+ sections[i].innerHTML;
	}
	// Adding insert section link on the bottom of the page
	sections[sections.length-2].innerHTML = sections[sections.length-2].innerHTML + '<a class="add" href="' + contextPath + '/web/addSection/addSection.do?sectionName='+'lastsection'+'&fileName='+fileName+'">[insert section <img alt="below" src="'+ contextPath +'/decorators/modifyContentControls/images/arrow_add_below.png" />]</a>';
